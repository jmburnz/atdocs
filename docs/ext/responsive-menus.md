...
Breakpoints are supplied using Drupal cores Breakpoints module in and defined in `at_core.breakpoints.yml`. Please see the page on [Breakpoints](../theming/breakpoints.md) for more information on at_core breakpoint groups.
